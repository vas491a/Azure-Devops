...
![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/intellisense1.png)
...
![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/intellisense2.png)
...
![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/intellisense3.png)
...
![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/syntax.png)
...
![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/tfc/switch_to_preview.gif)
...
![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/tfc/login_view.gif)

Once logged in, you are prompted to choose which Organization to view workspaces in.

![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/tfc/choose_org_view.png)
...
![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/tfc/workspace_view.gif)
...
![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/tfc/workspace_run_view.gif)

If a Run has been Planned or Applied, you can view the raw log for each by selecting the button on each Run.

![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/tfc/plan_apply_view.gif)
...
![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/module_calls.png)

If the module comes from the Terraform Registry, a link to open the documentation in a browser is provided.

![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/module_calls_doc_link.png)
...
![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/module_providers.png)
...
![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/pre-fill.png)
...
![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/code_lens.png)
...
- If you're interested in the development of the extension, you can read about our [development process](https://github.com/hashicorp/vscode-terraform/blob/f-tfc/DEVELOPMENT.md)

### Settings Migration

Read more about [changes in settings options introduced in v2.24.0](https://github.com/hashicorp/vscode-terraform/blob/f-tfc/docs/settings-migration.md).
...
![](https://github.com/hashicorp/vscode-terraform/raw/f-tfc/docs/pin_version.png)
...
We are an open source project on GitHub and would enjoy your contributions! Consult our [development guide](https://github.com/hashicorp/vscode-terraform/blob/f-tfc/DEVELOPMENT.md) for steps on how to get started. Please [open a new issue](https://github.com/hashicorp/terraform-vscode/issues) before working on a PR that requires significant effort. This will allow us to make sure the work is in line with the project's goals.
